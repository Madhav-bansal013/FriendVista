...
function Register() {
  ...
  return (
    <div className='bg-bgColor w-full h-[100vh] flex items-center justify-center p-6'>
      <div className="w-full md:w-2/3 h-fit lg:h-full 2xl:h-5/6 py-8 lg:p-0
      flex flex-row-reverse bg-primary rounded-xl overflow-hidden shadow- xl">
        ...
        <div className='w-full lg:w-1/2 h-full p-10 flex flex-col justify-center'>
          ...
          <p className="text-base text-ascent-1 font-semibold">Create your account </p>
              ...
              <TextInput
                ...
                register={register("cPassword", {
                  validate: (value) => {
                    ...
                    // console.log(password); //it takes from above password field
